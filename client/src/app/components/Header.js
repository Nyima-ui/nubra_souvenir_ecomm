...
const Header = () => {
  ...
  return (
    <nav className="flex justify-between items-center px-7.5 py-4 relative bg-neutral-bg sm:hidden">
      ...
      {isMenuOpened && (
        <ul className="absolute border top-full right-7.5 bg-[#30221B] text-white pt-10.5 pb-8 px-6 text-xl space-y-5 w-[276px] font-grotesk-500 tracking-[0.01em]">
          <li>
          ...
          <div className="flex gap-2 items-center">
            ...
            ></Image>
            <span className="text-base font-grotesk-400 tracking-[0.02em]">9419529117</span>
          </div>
        </ul>
      )}
    </nav>
