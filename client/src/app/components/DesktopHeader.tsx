...
const DesktopHeader = () => {
  return (
    <nav className="max-sm:hidden bg-black text-white text-[16.5px] font-grotesk-400 flex items-center justify-between max-w-[1321px] mx-auto px-5 md:px-10 py-2.5 rounded-[500px]">
      <Link href="/">
        <Image
          src="/images/logo.svg"
